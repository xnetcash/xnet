...
// xnet includes.
#include <..\src\script\xnetconsensus.h>
...
int main()
{
    std::cout << "xnetconsensus version: " << xnetconsensus_version() << std::endl;
    ...
    xnetconsensus_error err;
    auto op0Result = xnetconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, xnetconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
